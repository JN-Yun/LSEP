...
def main(args):
    ...
    folder_name = f"{model_string_name}-enc{args.encoder_depth}-{ckpt_string_name}-size-{args.resolution}-vae-{args.vae}-" \
                  f"cfg-{args.cfg_scale}-seed-{args.global_seed}-{args.mode}-{args.name_add}"
