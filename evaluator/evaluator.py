...
def main():
    ...
    print(f"Method: {args.sample_batch.split('/')[-1].split('.npz')[0]}\n")
    ...
    with open(f"./{args.sample_batch.split('/')[-1].split('.npz')[0]}.txt", "w") as f:
        f.write(f"Method: {args.sample_batch.split('/')[-1].split('.npz')[0]}\n")
